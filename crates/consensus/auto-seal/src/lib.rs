...
// //!
// //! The Mining task polls a [MiningMode], and will return a list of transactions that are ready
// to //! be mined.
// //!
// //! These downloaders poll the miner, assemble the block, and return transactions that are ready
// to //! be mined.
...
//         trace!(target: "consensus::auto", num=self.best_block, hash=?self.best_hash, "inserting
// new block");         self.headers.insert(header.number, header);
